...
// Laya.init(600, 400);
// //激活资源版本控制
// Laya.ResourceVersion.enable("version.json", Handler.create(null, resourceLoad), Laya.ResourceVersion.FILENAME_VERSION);

// function resourceLoad(){
// 	Laya.loader.load("res/atlas/comp.atlas", Handler.create(null, onLoadComp));
// }

// function onLoadComp(): void {
// 	//实例UI界面
